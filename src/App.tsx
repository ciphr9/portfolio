...
function App() {
  return (
    <div className="cursor-default flex flex-col h-screen bg-slate-800 bg-gradient-to-tr from-slate-500 via-white to-slate-300 text-black dark:from-black dark:via-black dark:to-slate-900 dark:text-slate-300">
